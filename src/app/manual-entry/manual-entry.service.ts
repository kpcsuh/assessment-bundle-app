...
export class ManualEntryService {
  ...
  //     return this.http.get(`${this.apiHostName}/bundle/itementry/html/${productCode}`);
  // }
  //
  // public fetchManualEntryJS(productCode: string): Observable<Response> {
  //     return this.http.get(`${this.apiHostName}/bundle/itementry/js/${productCode}`);
  // }
  //
  // public fetchManualEntryCSS(productCode: string): Observable<Response> {
  //     return this.http.get(`${this.apiHostName}/bundle/itementry/css/${productCode}`);
  // }
